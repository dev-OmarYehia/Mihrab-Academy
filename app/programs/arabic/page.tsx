...
const modules = [
  { num: "01", title: "Reading & Writing", desc: "Master the Arabic alphabet, vowels, and script from scratch. Students learn to read fluently with correct pronunciation and write Arabic with proper form — the foundation of all further study." },
  { num: "02", title: "Conversational Arabic", desc: "Build practical speaking skills through structured dialogue, vocabulary expansion, and real-life scenarios. Our teachers use Modern Standard Arabic alongside Quranic Arabic to give students full fluency." },
  { num: "03", title: "Quranic Arabic", desc: "Dive deep into the language of the Quran — its grammar (Nahw), morphology (Sarf), and rhetorical beauty. Understand the Quran directly without relying on translations." },
  { num: "04", title: "Grammar & Composition", desc: "Advanced study of Arabic grammar rules, sentence structure, and written composition. Students develop the ability to read classical texts and write clearly in Arabic." },
];
  ...
  return (
    <div className="font-serif bg-[#0f1a14] text-white min-h-screen">
      ...
      <section className="bg-[#1a3a2f] pt-32 pb-16 px-10 md:px-20">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-2 text-white/30 text-sm mb-8">
            ...
            <span className="text-white/60">Arabic Language</span>
          </div>
          <div className="w-12 h-12 rounded-xl bg-[#c9a96e]/10 flex items-center justify-center text-[#c9a96e] mb-6">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M5 8l6 6M4 14l6-6 2-3M2 5h12M7 2h1M22 22l-5-10-5 10M14 18h6"/></svg>
          </div>
          <p className="text-[#c9a96e] uppercase tracking-widest text-xs mb-3">Learn the Language of the Quran Your Way</p>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <h1 className="text-5xl md:text-6xl font-light text-white">Arabic Language</h1>
      ...
      <section className="bg-[#0d1510] px-10 md:px-20 py-20">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-12">
          <div className="flex-1">
            ...
            <p className="text-white/60 leading-relaxed">The language of the Qur'an — and the most wonderful language of all time. Here you can learn according to your level and goals, whether you're a complete beginner or looking to deepen your understanding of classical Arabic texts. Our native Arabic-speaking teachers guide you every step of the way.</p>
          </div>
          <div className="md:w-72">
            <div className="bg-[#152a20]/60 border border-white/8 rounded-2xl p-6">
              ...
              <ul className="space-y-3">
                {["Reading & Writing Arabic","Conversational Arabic","Quranic Arabic Grammar","Nahw & Sarf (Morphology)","Free trial lesson included"].map((item)=>(
      ...
      <section className="bg-[#0d1510] px-10 md:px-20 py-24 text-center">
        ...
        <h2 className="text-4xl md:text-5xl font-light text-white mb-4">Ready to Begin Your <span className="text-[#c9a96e] italic">Arabic Language</span> Journey?</h2>
